...
if not os.path.exists(f'datasets{dim}'):
    os.makedirs(f'datasets{dim}')
numpy.savetxt(f'datasets{dim}/cl_cd-uniform.csv', cl_cd,delimiter=',')
numpy.savetxt(f'datasets{dim}/xcp-uniform.csv', xcp,delimiter=',')
numpy.savetxt(f'datasets{dim}/cd-uniform.csv', cd,delimiter=',')
numpy.savetxt(f'datasets{dim}/data-uniform.csv', dataset,delimiter=',')
# %%
