...
parser.add_argument('--dataset_loc1',dest='dataset_loc1',nargs='*',help='''The location of the datasets to be used. The dataset location is "dataset_{dataset_loc1}.csv". Default: "uniform_downsampled_point2binsize"''',default=['uniform_downsampled_point2binsize'])         
            ...
            for layer_conf in layers:
                ...
                for epoch in range(n_EPOCHS):
                    ...
                    if cur_loss < best_loss:
                        ...
                        print(f'Epoch: {epoch} Loss: {cur_loss/num_batch:.3E}')
                
                best_losses[f'{regularization}_{layer_conf}_{loc1}'] = best_loss.item()
