...
numpy.savetxt(f'cl_cd-uniform-transfer.csv', cl_cd,delimiter=',')
numpy.savetxt(f'xcp-uniform-transfer.csv', xcp,delimiter=',')
numpy.savetxt(f'cd-uniform-transfer.csv', cd,delimiter=',')
numpy.savetxt(f'data-uniform-transfer.csv', dataset,delimiter=',')
# %%
