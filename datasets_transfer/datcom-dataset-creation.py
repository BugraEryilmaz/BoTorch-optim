...
cl_cd, xcp, cd = numpy.empty((batch_number,25)), numpy.empty((batch_number,25)), numpy.empty((batch_number,25))
index = 0
...
numpy.savetxt('cl_cd.csv', cl_cd,delimiter=',')
numpy.savetxt('xcp.csv', xcp,delimiter=',')
numpy.savetxt('cd.csv', cd,delimiter=',')
numpy.savetxt('data.csv', clipped_points,delimiter=',')
# %%
